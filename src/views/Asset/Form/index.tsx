                                    ...
                                    <div className="flex flex-col items-center justify-center">
                                        <div className="rounded-md mt-2 w-[200px] h-[132px] overflow-hidden flex justify-center border mb-2">
                                            {(!selectedImage && asset?.img_url) ? (
                                                <img src={`${process.env.REACT_APP_API_URL}/uploads/${asset?.img_url}`} alt="asset-image" />
                                            ) : (
                                                <img src={``} alt="" />
                                            )}
                            ...
                            <Col sm={6} md={3}>
                                <FormGroup>
                                    ...
                                    {(formik.errors.fsn_no && formik.touched.fsn_no) && (
                                        <span className="text-red-500 text-sm">{formik.errors.fsn_no as string}</span>
                                    )}
                                </FormGroup>
                            </Col>
                            <Col sm={6} md={6}>
